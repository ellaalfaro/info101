...
# Line 1: Pull out all rows where abundance was more than 400
flowcyto[flowcyto$abundance > 400, ]

# Line 2: Pull out the abundances from the first cast at the first station
flowcyto[flowcyto$station_id == 1 & flowcyto$cast == 1, 5]


# Line 3: Set all the values in abundance to NA for the first cast at the first
# station
